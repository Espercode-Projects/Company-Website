...
const Navbar = ({
  ...
  return (
    <motion.header
      ...
      className="relative z-50 flex items-center justify-between px-4 md:px-8 lg:px-16 py-6"
    >
      {/* Logo */}
      <motion.div
        ...
        {[
          ...
          <div key="services" className="relative">
            <motion.button
              ...
              className="text-white text-sm font-medium hover:text-green-400 transition-all duration-300 flex items-center space-x-1 group"
              whileHover={{
                scale: 1.05,
                textShadow: "0 0 8px rgba(34, 197, 94, 0.8)",
              }}
          ...
          typeof item === "string" ? (
            <motion.a
              key={item}
              href="#"
              className="text-white text-sm font-medium hover:text-green-400 transition-all duration-300 relative group"
              whileHover={{
                scale: 1.05,
                textShadow: "0 0 8px rgba(34, 197, 94, 0.8)",
              }}
...
const Hero = () => {
  ...
  return (
    <div className="relative  min-h-screen bg-gradient-to-br from-slate-800 via-slate-900 to-black overflow-hidden">
      ...
      {/* Main Content */}
      <motion.div
        className="relative z-10 flex flex-col lg:flex-row items-center justify-between px-4 md:px-8 lg:px-16 py-12 min-h-[calc(100vh-200px)] mb-5"
        style={{ y: y2 }}
      >
        {/* Left Content */}
        <HeroContent
